...
async def generate_workflow_summary(
    ...
    summary_prompt = (
        ...
        f'- DO mention key outcomes the user cares about: approval status, ticket numbers (e.g. RITM0010005), amounts.\n'
        f'- IMPORTANT: If any step result contains a "url" field along with a ticket/reference number, you MUST format it as a clickable markdown link: [RITM0010005](https://the-url-from-results). Always look for "url" keys in the step results and use them.\n'
