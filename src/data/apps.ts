...
export const APP_CATALOG: AppDefinition[] = [
  ...
  // --- Pro Apps ---
  { slug: 'google-workspace', name: 'Google Workspace', description: 'Email, calendar, docs, and collaboration suite for businesses', icon: 'Package', logoUrl: '', category: 'Productivity', actions: [], credentialFields: [], pro: true },
  { slug: 'github', name: 'GitHub', description: 'Source code management and CI/CD platform for developers', icon: 'Package', logoUrl: '', category: 'DevOps', actions: [], credentialFields: [], pro: true },
  { slug: 'gitlab', name: 'GitLab', description: 'Complete DevOps platform with Git repository and CI/CD pipelines', icon: 'Package', logoUrl: '', category: 'DevOps', actions: [], credentialFields: [], pro: true },
  { slug: 'datadog', name: 'Datadog', description: 'Monitoring and observability platform for cloud and infrastructure', icon: 'Package', logoUrl: '', category: 'Monitoring', actions: [], credentialFields: [], pro: true },
  { slug: 'pagerduty', name: 'PagerDuty', description: 'Incident response and on-call management platform', icon: 'Package', logoUrl: '', category: 'DevOps', actions: [], credentialFields: [], pro: true },
  { slug: 'splunk', name: 'Splunk', description: 'Data analytics platform for searching, monitoring, and investigating data', icon: 'Package', logoUrl: '', category: 'Data & Analytics', actions: [], credentialFields: [], pro: true },
  { slug: 'terraform', name: 'Terraform', description: 'Infrastructure as code tool for provisioning and managing cloud resources', icon: 'Package', logoUrl: '', category: 'Cloud Infrastructure', actions: [], credentialFields: [], pro: true },
  { slug: 'jenkins', name: 'Jenkins', description: 'Open-source automation server for continuous integration and delivery', icon: 'Package', logoUrl: '', category: 'DevOps', actions: [], credentialFields: [], pro: true },
  { slug: 'circleci', name: 'CircleCI', description: 'Continuous integration and delivery platform for automated testing', icon: 'Package', logoUrl: '', category: 'DevOps', actions: [], credentialFields: [], pro: true },
  { slug: 'zendesk', name: 'Zendesk', description: 'Customer support and help desk platform for service management', icon: 'Package', logoUrl: '', category: 'Customer Support', actions: [], credentialFields: [], pro: true },
  { slug: 'hubspot', name: 'HubSpot', description: 'Marketing, sales, and service platform for customer relationship management', icon: 'Package', logoUrl: '', category: 'CRM', actions: [], credentialFields: [], pro: true },
  { slug: 'marketo', name: 'Marketo', description: 'Marketing automation platform for lead management and campaigns', icon: 'Package', logoUrl: '', category: 'Marketing', actions: [], credentialFields: [], pro: true },
  { slug: 'tableau', name: 'Tableau', description: 'Business intelligence and data visualization platform', icon: 'Package', logoUrl: '', category: 'Business Intelligence', actions: [], credentialFields: [], pro: true },
  { slug: 'power-bi', name: 'Power BI', description: 'Business analytics and reporting platform with interactive dashboards', icon: 'Package', logoUrl: '', category: 'Business Intelligence', actions: [], credentialFields: [], pro: true },
  { slug: 'looker', name: 'Looker', description: 'Data platform for business intelligence and embedded analytics', icon: 'Package', logoUrl: '', category: 'Business Intelligence', actions: [], credentialFields: [], pro: true },
  { slug: 'mongodb', name: 'MongoDB', description: 'NoSQL database platform for storing and managing document data', icon: 'Package', logoUrl: '', category: 'Database', actions: [], credentialFields: [], pro: true },
  { slug: 'redis', name: 'Redis', description: 'In-memory data store for caching and real-time applications', icon: 'Package', logoUrl: '', category: 'Database', actions: [], credentialFields: [], pro: true },
  { slug: 'elasticsearch', name: 'Elasticsearch', description: 'Search and analytics engine for indexing and querying data', icon: 'Package', logoUrl: '', category: 'Database', actions: [], credentialFields: [], pro: true },
  { slug: 'okta', name: 'Okta', description: 'Identity and access management platform for secure user authentication', icon: 'Package', logoUrl: '', category: 'Identity & Access', actions: [], credentialFields: [], pro: true },
  { slug: 'auth0', name: 'Auth0', description: 'Authentication and authorization platform for application security', icon: 'Package', logoUrl: '', category: 'Identity & Access', actions: [], credentialFields: [], pro: true },
  { slug: 'crowdstrike', name: 'CrowdStrike', description: 'Endpoint detection and response platform for cybersecurity', icon: 'Package', logoUrl: '', category: 'Security', actions: [], credentialFields: [], pro: true },
  { slug: 'sentinelone', name: 'SentinelOne', description: 'Endpoint protection and threat prevention platform', icon: 'Package', logoUrl: '', category: 'Security', actions: [], credentialFields: [], pro: true },
  { slug: 'twilio', name: 'Twilio', description: 'Communications platform for SMS, voice, and video integration', icon: 'Package', logoUrl: '', category: 'Communication', actions: [], credentialFields: [], pro: true },
  { slug: 'sendgrid', name: 'SendGrid', description: 'Email delivery and management platform for transactional messages', icon: 'Package', logoUrl: '', category: 'Communication', actions: [], credentialFields: [], pro: true },
  ...
  { slug: 'microsoft-teams', name: 'Microsoft Teams', description: 'Team collaboration platform with chat, calls, and file sharing', icon: 'Package', logoUrl: '', category: 'Collaboration', actions: [], credentialFields: [], pro: true },
...
export const CONFIGURABLE_SLUGS = new Set(['servicenow', 'aws', 'snowflake', 'slack', 'sharepoint'])
